...
const UserSchema = new mongoose.Schema({
  ...
  phone: {
    ...
    unique: true,
    trim: true,
    // Validation for Danish phone numbers - not used version 1.0
    // validate: {
    //   validator: function (value) {
    //     // Brug en regelmæssig udtryk (regex) til at tjekke dansk telefonnummer
    //     const danishPhoneNumberRegex = /^(?:\+45|45)?(\d{8})$/;
    //     return danishPhoneNumberRegex.test(value);
    //   },
    //   message: (props) =>
    //     `${props.value} er ikke et gyldigt dansk telefonnummer!`,
    // },
  },
  phone_code: {
    type: String,
