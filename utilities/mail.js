...
// This handles sending emails to users.
    ...
    case "confirm_email":
      ...
      await transporter.sendMail({
        ...
        html: `
            ...
            <a href="${confirmationLink}" target="_blank" style="display: inline-block; background-color: #fd746c; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Bekræft din e-mail</a>
        ...
        html: `
            <div style="background-color: #f7f7f7; padding: 20px; font-family: Arial, sans-serif;">
                <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    ...
                    <h2 style="color: #fd746c; text-align: center;">🔓 Nulstilling af Kodeord</h2>
                    
                    <p>Hej!</p>
                    <p>Vi modtog en anmodning om at nulstille dit kodeord på Student Books. Din unikke kode til nulstilling er:</p>
                    
                    <div style="background-color: #fd746c; color: #ffffff; text-align: center; padding: 10px; font-size: 20px; border-radius: 5px; margin: 20px 0;">
